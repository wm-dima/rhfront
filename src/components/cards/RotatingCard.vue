<template>
  <div class="rotating-card-container" :class="{'manual-flip' : manualRotate, 'hover': manualRotateState}">
    <md-card class="md-card-rotate" :class="[cardClass , cardColor]">
      <div class="front" :class="{'front-background' : layerBackground}" :style="bgFrontFullCards(frontCardImage)">
      ...
      <div class="back" :class="{'back-background' : layerBackground}" :style="bgBackFullCards(backCardImage)">
