  ...
  <md-card class="md-card-profile"
    ...
    <template v-if="type !== 'horizontal'">
      <md-card-header
        ...
        :class="{'md-card-header-image': !cardAvatar , 'md-card-avatar': cardAvatar}">
        <a :href="cardLink()">
        ...
        <div class="colored-shadow" v-if="!noColoredShadow && !shadowNormal" :style="shadowImageProfile(cardImage)"></div>
      </md-card-header>
    ...
    <template v-else>
      <div class="md-layout">
        <div class="md-layout-item" :class="{'md-size-45 md-xsmall-size-100': !smallImg, 'md-size-33 md-small-size-100': smallImg}">
          <md-card-header
            :shadow-normal="shadowNormal"
            :no-colored-shadow="noColoredShadow"
        ...
        <div class="md-layout-item" :class="{'md-size-55 md-xsmall-size-100': !smallImg, 'md-size-66 md-small-size-100': smallImg}">
          <md-card-content v-if="$slots.cardContent">
            <slot name="cardContent"></slot>
          </md-card-content>

          <md-card-actions md-alignment="left" :class="{'justify-content-center': textCenter}" v-if="$slots.cardAction">
            <slot name="cardAction"></slot>
          </md-card-actions>
        </div>
      </div>
